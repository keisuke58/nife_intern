...
refs = [
    ...
    'Joshi V, et al. (2025). Community-level profiling of peri-implant microbiome. mSystems [in press].',
    ...
    'Klempt F, Nishioka K, Soleimani M, Junker P (2024). Modelling biofilm growth with the extended Hamilton principle. Biomech Model Mechanobiol 23.',
