...
\begin{enumerate}
  ...
  \item \textbf{プライア不一致。} L1 プライアは eHOMD キュレーションの
        ...
        歯周炎データセット（Duran-Pinedo et~al.~2021、PRJNA725874）に適用すると、
...
Joshi AA, Szafrański SP, Steglich M, et~al. (2025). インプラント周囲炎の診断バイオマーカーを明らかにするマイクロバイオーム・メタトランスクリプトーム統合解析.
...
拡散駆動バイオフィルム成長の Hamilton 原理ベースモデル.
...
Klempt F, Geisler H, Soleimani M, Junker P (2025). 新しい相互作用スキームを持つ連続体マルチスピーシーズ・バイオフィルムモデル. \textit{arXiv:2509.01274 [q-bio.QM]}.
