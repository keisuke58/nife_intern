...
- **Root-level scripts** (the ~129 `*.py` at repo root) import siblings *bare*, e.g. `from guild_replicator_dieckow import GUILD_ORDER` or `from pub_style import ...`. → Run these **from the repo root**: `python run_glv_loo.py --hold 0 ...`.
