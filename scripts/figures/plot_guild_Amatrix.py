...
def main():
    ...
    ap.add_argument('--fit-json', default=str(Path(__file__).resolve().parents[2] / 'results' / 'dieckow_cr' / 'fit_guild.json'))
    ap.add_argument('--phi-npy', default=str(Path(__file__).resolve().parents[2] / 'results' / 'dieckow_otu' / 'phi_guild.npy'))
    ap.add_argument('--out-dir', default=str(Path(__file__).resolve().parents[2] / 'results' / 'dieckow_otu'))
