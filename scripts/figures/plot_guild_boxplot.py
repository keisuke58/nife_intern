...
PHI_NPY   = Path(__file__).resolve().parents[2] / 'results/dieckow_otu/phi_guild_excel_class.npy'
SUMM_JSON = Path(__file__).resolve().parents[2] / 'results/dieckow_otu/guild_summary_excel_class.json'
OUT_DIR   = Path(__file__).resolve().parents[2] / 'results/dieckow_otu'
