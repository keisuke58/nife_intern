...
_nife_dir = Path(__file__).resolve().parents[2]
...
def build_guild_mask(n_sp, guilds):
    try:
        import openpyxl
        SI_XLSX = Path(__file__).resolve().parents[2] / 'Datasets' / '20260416_AbutmentPapernpjBiofilmsDieckow_SI_Relationships.xlsx'
...
def main():
    ...
    ap.add_argument('--phi-npy',         default=str(Path(__file__).resolve().parents[2] / 'results' / 'dieckow_otu' / 'phi_guild.npy'))
    ap.add_argument('--out-json',        default=str(Path(__file__).resolve().parents[2] / 'results' / 'dieckow_cr' / 'fit_guild_hamilton_masked_v2.json'))
    ap.add_argument('--warm-start-json', default=str(Path(__file__).resolve().parents[2] / 'results' / 'dieckow_cr' / 'fit_guild_hamilton_masked.json'),
    ...
    ap.add_argument('--struct-xlsx',     default=str(Path(__file__).resolve().parents[2] / 'Datasets' /
