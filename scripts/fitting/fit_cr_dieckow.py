...
RESULTS_DIR = Path(__file__).resolve().parents[2] / 'results' / 'dieckow_cr'
RESULTS_DIR.mkdir(parents=True, exist_ok=True)

DATA_PATH  = Path(__file__).resolve().parents[2] / 'results' / 'Ab_dieckow_timeseries' / 'phi_obs.npy'
FIT_JSON   = Path(__file__).resolve().parents[2] / 'results' / 'dieckow_fits' / 'fit_joint_5sp_1000p.json'
LAMBDA_REG = 0.01
