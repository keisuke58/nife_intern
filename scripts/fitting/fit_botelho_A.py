...
json.dump(result, open(OUT / f'botelho_A_comparison{SUFFIX}.json', 'w'), indent=2)
print(f'Saved → {OUT}/botelho_A_comparison{SUFFIX}.json', flush=True)
...
fig.tight_layout()
for ext in ('png', 'pdf'):
    fig.savefig(OUT / f'fig_botelho_A_comparison{SUFFIX}.{ext}', dpi=150, bbox_inches='tight')
    print(f'Saved {OUT}/fig_botelho_A_comparison{SUFFIX}.{ext}')
