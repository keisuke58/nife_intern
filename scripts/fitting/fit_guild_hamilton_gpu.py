...
def main():
    ...
    ap.add_argument('--out-json', default=str(Path(__file__).resolve().parents[2] / 'results' / 'dieckow_cr' / 'fit_guild_hamilton_gpu.json'))
    ap.add_argument('--warm-start-json', default=str(Path(__file__).resolve().parents[2] / 'results' / 'dieckow_cr' / 'fit_guild.json'))
