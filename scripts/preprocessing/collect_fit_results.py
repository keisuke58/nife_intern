...
OTU = Path(__file__).resolve().parents[2] / 'results' / 'dieckow_otu'
...
LOGS = {
    'CPU': Path(__file__).resolve().parents[2] / 'results' / 'dieckow_cr' / 'fit_guild_hamilton_masked.log',
    'GPU': Path(__file__).resolve().parents[2] / 'results' / 'dieckow_cr' / 'fit_guild_hamilton_masked.gpu.log',
}
